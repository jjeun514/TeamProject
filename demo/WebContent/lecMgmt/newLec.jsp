...
<!-- 강의장 이름, 강사 이름 input
	...
	<tr>
		<th>강의명</th>
		<td><input type="text" name="lecture" size=31 maxlength=50 id="lecture" placeholder="강의명 입력(최대 50자)">
	...
	<tr>
		...
		~ <input type="date" value="" name="endDate" id="endDate"></td>
	</tr>
	<tr>
		<th>강의장</th>
		<!-- lecRoom(varchar:5) - not null -->
		<td><input type="text" name="classroom" size=31 maxlength=5 id="classroom" placeholder="강의장 입력(최대 5자)">
		<br><span id="msg2">※필수 - 강의장 입력(최대 5자)</span></td>
	</tr>
	<tr>
		<th>강사</th>
		<!-- ename(varchar:15) - not null -->
		<td><input type="text" name="instructor" size=31 maxlength=15 id="instructor" placeholder="강사명 입력">
